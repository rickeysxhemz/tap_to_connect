...
import vcfImage from './widget-selector/widget-images/vcf.png';
import connectImage from './widget-selector/widget-images/connect.png';
...
import { VcfWidgetDialog } from './vcf-widget/vcf-widget-dialog';
import { ConnectWidgetDialog } from './connect-widget/connect-widget-dialog';
...
export const WidgetList: Record<WidgetType, WidgetListItem> = {
  ...
  [WidgetType.Vcf]: {
    ...
    image: vcfImage,
    description: message(
      'Fill up the information to allow VCF download in your profile.'
    ),
    dialog: VcfWidgetDialog,
  },
  [WidgetType.Connect]: {
    name: message('Connect'),
    image: connectImage,
    description: message(
      'Fill up the information to allow Connect to your profile.'
    ),
    dialog: ConnectWidgetDialog,
  },
};
