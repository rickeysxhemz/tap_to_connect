...
import { VcfWidgetRenderer } from './vcf-widget/vcf-widget-renderer';
import { ConnectWidgetRenderer } from './connect-widget/connect-widget-renderer';
...
> = {
  ...
  [WidgetType.Vcf]: VcfWidgetRenderer,
  [WidgetType.Connect]: ConnectWidgetRenderer,
};
