...
import { BelinkDashboardLayout } from './dashboard/layout/belink-dasbboard-layout';
import { RegisterNfc } from './dashboard/nfclink/RegisterNfc';
import RegisteringNfc from './dashboard/nfclink/RegisteringNfc';
  ...
  return (
    <BrowserRouter basename={html_base_uri}>
      ...
      <Routes>
        ...
        />
        <Route
          path="/business-card/registering"
          element={
            <React.Suspense fallback={<FullPageLoader />}>
              <ActiveWorkspaceProvider>
                <RegisteringNfc />
