...
use Common\NfcLink\NfcLinkController;
...
Route::group(['prefix' => 'v1'], function () {
    Route::group(['middleware' => ['optionalAuth:sanctum', 'verified']], function () {
        ...
        // NFC Links
        Route::get('nfc-links', [NfcLinkController::class, 'index']);
        Route::post('nfc-links', [NfcLinkController::class, 'store']);
        Route::put('nfc-links/{id}', [NfcLinkController::class, 'update']);
        Route::delete('nfc-links/{nfcIds}', [NfcLinkController::class, 'destroy']);
